...
StartScreen::StartScreen() {
	...
	// logo entities
	mLogo = new GLTexture("breakout_logo.png", 0, 0, 1036, 277);
	mAnimatedLogo = new AnimatedGLTexture("breakout_logo.png", 0, 0, 1036, 277, 1, 0.2f, Animation::Layouts::Vertical);
